...
\hline
{\bf Component} & {\bf Reference Number} & {\bf Requirement Name}\\
\hline
...
diagrams, class diagrams, state-transition diagrams, sequence diagram, or entity-relationship diagrams, etc. $>$
